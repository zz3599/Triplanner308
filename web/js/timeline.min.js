var Timeline = function(container, date) {
    ...
    this.updateIntervalAndEvents = function(start, end, tripid, events) {
        ...
        for (var i = 0; i < events.length; i++) {
            this.events[i] = {
                name: events[i].comment,
                date: events[i].startTime,
                day: events[i].startTime.getDate(),
                month: events[i].startTime.getMonth(),
                year: events[i].startTime.getFullYear(),
                content: events[i].comment
            };
        }
        this.render();
    };
...
Timeline.Bubble = function(timeline) {
    ...
    this.setContent = function(events) {
        ...
        addEvent.click(function() {
            ...
            var maxDate = new Date(minDate.getTime()).setDate(minDate.getDate() + 1);
            window.app.initTimepickers($('#eventStart'), $('#eventEnd'), null, null);
        });
    };
    this.initAddEventModal = function() {
        ...
        $("#dialog-form").dialog({
            ...
            buttons: {
                "Finish": function() {
                    var bValid = true;
                    bValid = bValid && valid(description.val()) && valid(startLocation.val()) && valid(endLocation.val()) &&
